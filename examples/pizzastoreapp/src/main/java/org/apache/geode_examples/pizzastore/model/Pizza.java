...
package org.apache.geode_examples.pizzastore.model;
...
public class Pizza implements Serializable {
    ...
    private static final long serialVersionUID = -1775981283444214005L;
    ...
    public String toString() {
        ...
        return String.format("%1$s Pizza having %2$s Sauce with Toppings %3$s",
            this.name, this.sauce, Arrays.toString(this.toppings.toArray()));
    }
